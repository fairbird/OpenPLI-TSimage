	...
	def getFEData(self, frontendDataOrg):
		if frontendDataOrg and len(frontendDataOrg):
			...
			if frontendDataOrg["tuner_type"] == "DVB-S":
				...
				return (tuner,
					(_("Frequency & Channel"), "%.3f MHz" % ((frontendData.get("frequency", 0) / 1000) / 1000.0) + " - Ch. " + getChannelNumber(frontendData["frequency"], frontendData.get("tuner_number",0)), TYPE_TEXT),
