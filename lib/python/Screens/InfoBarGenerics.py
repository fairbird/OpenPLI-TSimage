...
class InfoBarShowMovies():
    ...
    def __init__(self):
        self['MovieListActions'] = HelpableActionMap(self, 'InfobarMovieListActions', {'movieList': (self.showMovies, _('Open the movie list')),
...
class InfoBarTimeshift():
    ...
    def saveTimeshiftFileForEvent(self):
        if self.timeshiftEnabled() and self.save_timeshift_only_current_event and self.timeshift_was_activated and self.save_timeshift_file:
            ...
            choice = [(_('Save and stop timeshift'), 'save'),
             (_('Save and restart timeshift'), 'restart'),
             (_("Don't save and stop timeshift"), 'stop'),
...
class InfoBarExtensions():
    ...
    def __init__(self):
        self.list = []
        self['InstantExtensionsActions'] = HelpableActionMap(self, 'InfobarExtensions', {'extensions': (self.showExtensionSelection, _('Show extensions...'))}, 1)
...
class InfoBarPiP():
    ...
    def __init__(self):
        ...
        if SystemInfo['PIPAvailable']:
            self['PiPActions'] = HelpableActionMap(self, 'InfobarPiPActions', {'activatePiP': (self.activePiP, self.activePiPName)})
            if self.allowPiP:
...
class InfoBarAudioSelection():
    ...
    def __init__(self):
        self['AudioSelectionAction'] = HelpableActionMap(self, 'InfobarAudioSelectionActions', {'audioSelection': (self.audioSelection, _('Audio options...'))})
...
class InfoBarSubserviceSelection():
    ...
    def __init__(self):
        self['SubserviceSelectionAction'] = HelpableActionMap(self, 'InfobarSubserviceSelectionActions', {'subserviceSelection': (self.subserviceSelection, _('Subservice list...'))})
        self['SubserviceQuickzapAction'] = HelpableActionMap(self, 'InfobarSubserviceQuickzapActions', {'nextSubservice': (self.nextSubservice, _('Switch to next sub service')),
         'prevSubservice': (self.prevSubservice, _('Switch to previous sub service'))}, -1)
        self['SubserviceQuickzapAction'].setEnabled(False)
        self.__event_tracker = ServiceEventTracker(screen=self, eventmap={iPlayableService.evUpdatedEventInfo: self.checkSubservicesAvail})
...
class InfoBarRedButton():
    ...
    def __init__(self):
        self['RedButtonActions'] = HelpableActionMap(self, 'InfobarRedButtonActions', {'activateRedButton': (self.activateRedButton, _('Red button...'))})
...
class InfoBarTimerButton():
    ...
    def __init__(self):
        self['TimerButtonActions'] = HelpableActionMap(self, 'InfobarTimerButtonActions', {'timerSelection': (self.timerSelection, _('Timer selection...'))})
...
class InfoBarVmodeButton():
    ...
    def __init__(self):
        self['VmodeButtonActions'] = HelpableActionMap(self, 'InfobarVmodeButtonActions', {'vmodeSelection': (self.vmodeSelection, _('Letterbox zoom'))})
...
class VideoMode(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = NumberActionMap(['InfobarVmodeButtonActions'], {'vmodeSelection': self.selectVMode})
        self.Timer = eTimer()
...
class InfoBarServiceNotifications():
    ...
    def __init__(self):
        self.__event_tracker = ServiceEventTracker(screen=self, eventmap={iPlayableService.evEnd: self.serviceHasEnded})
...
class InfoBarCueSheetSupport():
    ...
    def __init__(self, actionmap = 'InfobarCueSheetActions'):
        self['CueSheetActions'] = HelpableActionMap(self, actionmap, {'jumpPreviousMark': (self.jumpPreviousMark, _('Jump to previous marked position')),
         'jumpNextMark': (self.jumpNextMark, _('Jump to next marked position')),
         'toggleMark': (self.toggleMark, _('Toggle a cut mark at the current position'))}, prio=1)
        self.cut_list = []
    ...
    def jumpPreviousMark(self):
        self.jumpPreviousNextMark(lambda x: -x - 450000, start=True)
...
class InfoBarTeletextPlugin():
    ...
    def __init__(self):
        ...
        if self.teletext_plugin is not None:
            self['TeletextActions'] = HelpableActionMap(self, 'InfobarTeletextActions', {'startTeletext': (self.startTeletext, _('View teletext...'))})
        else:
...
class InfoBarSubtitleSupport(object):
    ...
    def __init__(self):
        ...
        self['SubtitleSelectionAction'] = HelpableActionMap(self, 'InfobarSubtitleSelectionActions', {'subtitleSelection': (self.subtitleSelection, _('Subtitle selection...'))})
        ...
        self.__event_tracker = ServiceEventTracker(screen=self, eventmap={iPlayableService.evStart: self.__serviceChanged,
...
class InfoBarServiceErrorPopupSupport():
    ...
    def __init__(self):
        self.__event_tracker = ServiceEventTracker(screen=self, eventmap={iPlayableService.evTuneFailed: self.__tuneFailed,
