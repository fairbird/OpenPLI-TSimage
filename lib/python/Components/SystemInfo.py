...
SystemInfo["hasXcoreVFD"] = HardwareInfo().get_device_model() in "osmega" and fileCheck("/sys/module/brcmstb_%s/parameters/pt6302_cgram" % HardwareInfo().get_device_model())
